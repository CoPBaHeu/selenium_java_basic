...
//         get third text of class "test" (should be "Test Text 4")
        ...
        System.out.println("Elements size: " + allElements.size());
        for (WebElement el : allElements) {
            System.out.println(el.getText());
        }
        System.out.println("3rd element: " + allElements.get(2).getText());

        /*System.out.println(driver.findElements(By.className("test")).size());
        System.out.println(driver.findElement(By.className("test")).getAttribute("class"));
